...
Dynamic Hand Gesture Recognition uses deep learning to recognize and classify different hand gestures from video data. The model is built using PyTorch and is based on the pretrained R(2+1)D architecture. This repository contains the structure of the dataset, code for preprocessing video data, training the model, and visualizing the results.
...
The model's code can be found in the file named "Recognition_Model.py".
